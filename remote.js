...
function gwSearch(keyword){
    return $.get(`https://my.gwu.edu/mod/directory/index.cfm?keywords=${keyword}&role=All&x=0&y=0&searchtype=people&f=xml`)
        .then(function(body){
...
InboxSDK.load(1, 'sdk_gw656_100bd7aa3a').then(function(sdk) {
    $('body').append(`<div id="loginIFrame"><iframe src="${chrome.extension.getURL('portal.html')}"></iframe></div>`);
